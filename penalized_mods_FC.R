...
#AUC calculation
pred.object.ridge.drug <- prediction(probs.ridge.drug, hard.drugs.test.fc$hard.drug)
...
#AUC calculation
pred.object.lasso.drug <- prediction(probs.lasso.drug, hard.drugs.test.fc$hard.drug)
...
#AUC calculation
probs.elastic.drug <- elastic.drug %>% predict(newdata = hard.drugs.test.fc %>% 
                                                 select(-hard.drug), type = "prob") %>% 
  mutate(prob = pmax(`0`, `1`)) %>% 
  select(prob)
pred.object.elastic.drug <- prediction(probs.elastic.drug, hard.drugs.test.fc$hard.drug)
...
#AUC calculation
pred.object.ridge.mj <- prediction(probs.ridge.mj, MJ.test.fc$mari.user)
...
#AUC calculation
pred.object.lasso.mj <- prediction(probs.lasso.mj, MJ.test.fc$mari.user)
...
#AUC calculation
probs.elastic.mj <- elastic.mj %>% predict(newdata = MJ.test.fc %>% 
                                                 select(-mari.user), type = "prob") %>% 
  mutate(prob = pmax(`0`, `1`)) %>% 
  select(prob)
pred.object.elastic.mj <- prediction(probs.elastic.mj, MJ.test.fc$mari.user)
...
#AUC calculation
pred.object.ridge.alc <- prediction(probs.ridge.alc, Alc.dep.test.fc$Alc)
...
#AUC calculation
pred.object.lasso.alc <- prediction(probs.lasso.alc, Alc.dep.test.fc$Alc)
...
#AUC calculation
probs.elastic.alc <- elastic.alc %>% predict(newdata = Alc.dep.test.fc %>% 
                                             select(-Alc), type = "prob") %>% 
  mutate(prob = pmax(`0`, `1`)) %>% 
  select(prob)
pred.object.elastic.alc <- prediction(probs.elastic.alc, Alc.dep.test.fc$Alc)
